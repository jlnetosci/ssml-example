...
st.markdown("""<div style="text-align: justify;">This is an example page for the <a href="https://pypi.org/project/st-social-media-links/" target="_blank"><code>st-social-media-links</code> package </a>. If you are interested you can also read our <a href="https://github.com/jlnetosci/st-social-media-links" target="_blank">documentation</a>.</div><p>""", unsafe_allow_html=True)
